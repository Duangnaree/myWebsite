...
var lyr_ndvi1_1 = new ol.layer.Image({
                            opacity: 1,
                            title: "ndvi (1)",
                            
                            
                            source: new ol.source.ImageStatic({
                               url: "./layers/ndvi1_1.png",
    attributions: ' ',
...
lyr_CambodiaLaosThailandVietnamMalaysiaMyanmarbilingual_0.setVisible(true);lyr_ndvi1_1.setVisible(true);
var layersList = [lyr_CambodiaLaosThailandVietnamMalaysiaMyanmarbilingual_0,lyr_ndvi1_1];
