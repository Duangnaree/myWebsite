...
var lyr_pl_amphoe_2 = new ol.layer.Vector({
                ...
                interactive: true,
    title: 'pl_amphoe<br />\
    <img src="styles/legend/pl_amphoe_2_0.png" /> อ.เนินมะปราง<br />\
    <img src="styles/legend/pl_amphoe_2_1.png" /> อ.เมืองพิษณุโลก<br />\
    <img src="styles/legend/pl_amphoe_2_2.png" /> อ.ชาติตระการ<br />\
    <img src="styles/legend/pl_amphoe_2_3.png" /> อ.นครไทย<br />\
    <img src="styles/legend/pl_amphoe_2_4.png" /> อ.บางกระทุ่ม<br />\
    <img src="styles/legend/pl_amphoe_2_5.png" /> อ.บางระกำ<br />\
    <img src="styles/legend/pl_amphoe_2_6.png" /> อ.พรหมพิราม<br />\
...
lyr_CambodiaLaosThailandVietnamMalaysiaMyanmarbilingual_0.setVisible(true);lyr_pl_tambon_1.setVisible(true);lyr_pl_amphoe_2.setVisible(true);lyr_pl_transportation_3.setVisible(true);lyr_pl_stream_4.setVisible(true);lyr_pl_village_5.setVisible(true);
var layersList = [lyr_CambodiaLaosThailandVietnamMalaysiaMyanmarbilingual_0,lyr_pl_tambon_1,lyr_pl_amphoe_2,lyr_pl_transportation_3,lyr_pl_stream_4,lyr_pl_village_5];
...
lyr_pl_village_5.set('fieldImages', {'NRD_CODE': '', 'VILL_CODE': '', 'VILL_NAM_T': '', 'PROV_CODE': '', 'AMP_CODE': '', 'TAM_CODE': '', });
...
lyr_pl_transportation_3.set('fieldLabels', {'LENGTH': 'header label', 'TRANS_TYP': 'no label', 'TYP_T': 'no label', 'NAME_T': 'no label', 'NAME_E': 'no label', 'TranNo': 'no label', 'TranTyp_n': 'no label', });
